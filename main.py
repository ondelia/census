...
print("Population of Exurban/Rural Distressed Regions: " + str(distressedArural) + "\n")
print("Population of Urban Watchlist Regions: " + str(distressedBurban))
print("Population of Exurban/Rural Watchlist Regions: " + str(distressedBrural) + "\n")
print("Population of Urban Non-Distressed Regions: " + str(distressedNurban))
print("Population of Exurban/Rural Non-Distressed Regions: " + str(distressedNrural) + "\n")
